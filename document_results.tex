...
\begin{document}
    ...
    \begin{table}[h]
        ...
        \begin{tabular}{|l|c|c|c|c|c|}
            ...
            0.3 & 552885 ± 696780 & 237460 ± 431059 & 79545 ± 138206 & 88715 ± 179807 & 42270 ± 7456 \\ \hline
            0.5 & 546215 ± 663396 & 248060 ± 439909 & 77235 ± 70058 & 92250 ± 196530 & 41940 ± 7482 \\ \hline
            0.7 & 544875 ± 626624 & 212950 ± 333163 & 78820 ± 15789 & 82170 ± 154774 & 41595 ± 6912 \\ \hline
            0.9 & 790365 ± 687614 & 311480 ± 356885 & 114505 ± 31257 & 94245 ± 26103 & 46390 ± 7295 \\ \hline
        \end{tabular}
    ...
    \begin{figure}[htbp]
        ...
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.3_threshold_0.1/opinions_history_1}
            \caption{Fragmentación con union al final}
            \label{fig:p_0.3_threshold_0.1_1}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.3_threshold_0.1/opinions_history_2}
            \caption{Fragmentación}
            \label{fig:p_0.3_threshold_0.1_2}
        \end{subfigure}
        \caption{Histórico de opiniones Prob. inter 0.3, confianza 0.1}
        \label{fig:p_0.3_threshold_0.1}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.5_threshold_0.15/opinions_history_1}
            \caption{Fragmentación}
            \label{fig:p_0.5_threshold_0.15_1}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.5_threshold_0.15/opinions_history_2}
            \caption{Polarización}
            \label{fig:p_0.5_threshold_0.15_2}
        \end{subfigure}
        \caption{Histórico de opiniones Prob. inter 0.5, confianza 0.15}
        \label{fig:p_0.5_threshold_0.15}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.7_threshold_0.1/opinions_history_1}
            \caption{Fragmentación con union al final}
            \label{fig:p_0.7_threshold_0.1_1}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.7_threshold_0.1/opinions_history_2}
            \caption{Fragmentación}
            \label{fig:p_0.7_threshold_0.1_2}
        \end{subfigure}
        \caption{Histórico de opiniones Prob. inter 0.7, confianza 0.1}
        \label{fig:p_0.7_threshold_0.1}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.33\linewidth]{results/p_0.7_threshold_0.2/opinions_history}
        \caption{Histórico de opiniones Prob. inter 0.7, confianza 0.2: Polarización}
        \label{fig:p_0.7_threshold_0.2}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.33\linewidth]{results/p_0.7_threshold_0.3/opinions_history}
        \caption{Histórico de opiniones Prob. inter 0.7, confianza 0.3: Consenso}
        \label{fig:p_0.7_threshold_0.3}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.9_threshold_0.1/opinions_history_1}
            \caption{Fragmentación}
            \label{fig:p_0.9_threshold_0.1_1}
        \end{subfigure}
        \begin{subfigure}[b]{0.48\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.9_threshold_0.1/opinions_history_2}
            \caption{Polarización}
            \label{fig:p_0.9_threshold_0.1_2}
        \end{subfigure}
        \caption{Histórico de opiniones Prob. inter 0.9, confianza 0.1}
        \label{fig:p_0.9_threshold_0.1}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.9_threshold_0.15/opinions_history_1}
            \caption{Polarización}
            \label{fig:p_0.9_threshold_0.15_1}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.9_threshold_0.15/opinions_history_2}
            \caption{Fragmentación}
            \label{fig:p_0.9_threshold_0.15_2}
        \end{subfigure}
        \begin{subfigure}[b]{0.32\linewidth}
            \includegraphics[width=\linewidth]{results/p_0.9_threshold_0.15/opinions_history_3}
            \caption{Fragmentación finalmente polarización}
            \label{fig:p_0.9_threshold_0.15_3}
        \end{subfigure}
        \caption{Histórico de opiniones Prob. inter 0.9, confianza 0.15}
        \label{fig:p_0.9_threshold_0.15}
    \end{figure}
    \FloatBarrier
    ...
    \begin{figure}[htbp]
        \centering
        \includegraphics[width=0.33\linewidth]{results/p_0.9_threshold_0.2/opinions_history}
        \caption{Histórico de opiniones Prob. inter 0.9, confianza 0.2: Polarización}
        \label{fig:p_0.9_threshold_0.2}
    \end{figure}
    \FloatBarrier
